...
quartic seam form
\[
s_4(u,v)=\frac{u^2+v^2}{2}+\lambda\Bigl(a\,u^4+b\,v^4+c\,u^2v^2\Bigr),
\qquad \lambda=\beta\kappa,
\]
...
and yields a positive quartic correction \(\mathcal{W}_4=\lambda(3a+3b+2c)/16
=\lambda/8\). The coefficients \(a,b,c\) thus have a direct physical
