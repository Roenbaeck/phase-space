...
\(\int_0^{2\pi}\cos^{2k-2}\theta\sin^2\theta\,d\theta\) to the diagonal integral
\(\int_0^{2\pi}\cos^{2k}\theta\,d\theta\) is \(1/(2k-1)\). For \(k=2\) this gives
\(1/3\); for \(k=3\) it gives \(1/5\). This ratio is the geometric origin of the
decreasing per-component weight of cross-coupling terms at higher jet orders.
\end{remark}
...
\(H(z)=\tfrac{1}{(2k)!}P_{i_1\cdots i_{2k}}z^{i_1}\cdots z^{i_{2k}}\) to be
non-negative for all \(z\): if \(H(z_0)<0\) for some direction \(z_0\), then
